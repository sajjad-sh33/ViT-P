...
class Mask2FormerHead(BaseDecodeHead):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 init_cfg=None,
                 Classification_Config_Path=None,
        ...
        self.cls_model.eval()
        # self.img_size = [518,1036]
        self.img_size = cfg.crops.global_crops_size
        # self.img_size = (518, 518) 
    ...
    def forward_test(self, inputs, img_metas, test_cfg,img):
        ...
        out_vocab_cls_results = mask_cls_result0 
        ...
        seg_mask = torch.einsum('bqc,bqhw->bchw', mask_cls_result, mask_pred_result)
        return seg_mask
    ...
    def create_class_tensor_no_loop(self, masks, image_path,img):
        ...
        max_coords = torch.tensor(max_coords_np)
        ...
        if chunks[-1].size(0) < target_size:
            ...
            # padding = self.padding[:padding_rows,:].to(normalized_coords0)
